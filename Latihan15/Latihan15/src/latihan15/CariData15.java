 ...
 * @author steven
 */
public class CariData15 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Cari Input Edit Data Anak");
        setResizable(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         * 
         * anak, maka cuma ada 1 kolom tanggal, yaitu : tanggallahir
         * 
         * 
         */
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        /**
         * 
         * Source Code untuk mengedit Data
         * 
         */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CariData15.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CariData15().setVisible(true);
            }
        });
    }

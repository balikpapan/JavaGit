 ...
 * @author steven
 */
public class CariData14 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton9.setText("Clear Pencarian");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CariData14.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CariData14().setVisible(true);
            }
        });
    }

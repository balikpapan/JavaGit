 ...
 * 
 * 
 * Final Release Untuk tanggal 30/06/2015
 * 
 */
public class CariData18 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Cari input Edit Istri/Suami");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        /**
         * 
         * Dibawah ini source code untuk fitur pencarian tanggal
         * 
         */
        ...
        String cariTanggal = "SELECT id,nik,nomerktp,namalengkap,alamat,tempatlahir,tanggallahir,jeniskelamin,agama,golongandarah FROM istri WHERE " + kolomTanggal1 + " = '" + dataTanggal1 + "'";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        /**
         * 
         * dibawah ini untuk fitur pencarian teks
         * 
         */
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        /**
         * 
         * Di bawah ini untuk fungsi pengisian data ke tabel
         * 
         */
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        /**
         * 
         * Di bawah ini kode untuk menghapus data
         * 
         */
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        /**
         * 
         * Source code untuk mengosongkan inputan data
         * 
         */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CariData18.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CariData18().setVisible(true);
            }
        });
    }

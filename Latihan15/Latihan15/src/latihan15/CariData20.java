 ...
 * 
 */
public class CariData20 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Cari Input Edit Pegawai");
        setResizable(false);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        /**
         * Dibawah ini fungsi untuk membersihkan variabel pencarian
         * 
         */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CariData20.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CariData20().setVisible(true);
            }
        });
    }

 ...
 * 
 */
public class CariData19 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        /**
         * 
         * Tombol ini berfungsi untuk pencarian data berupa tanggal, untuk tabel
         * 
         * anak, hanya ada satu kolom yg memiliki data tanggal, yaitu: tanggallahir
         * 
         */
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        /**
         * 
         * Kode untuk menyimpan data ke dalam database POstgreSQL
         * 
         */
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        /**
         * 
         * Source code untuk clear inputan data
         * 
         * 
         */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CariData19.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CariData19().setVisible(true);
            }
        });
    }

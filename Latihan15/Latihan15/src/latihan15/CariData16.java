 ...
 * @author steven
 */
public class CariData16 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Cari Edit Input Istri/Suami");
        setResizable(false);
        ...
        jButton9.setText("Clear Inputan");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        /**
         * 
         * di bawah ini source code untuk fitur pencarian tanggal
         * 
         */
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        /**
         * 
         * di bawah ini untuk fitur pencarian teks
         * 
         */
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            while(rs.next()){
                ...
                String tanggalLahir2 = terformat1.format(tanggalLahir);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CariData16.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CariData16().setVisible(true);
            }
        });
    }

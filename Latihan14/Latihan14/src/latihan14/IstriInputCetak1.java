 ...
 * @author steven
 */
public class IstriInputCetak1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form IstriInputCetak1
     */
    public IstriInputCetak1() {
        initComponents();
        ...
        jComboBox2.addItem("Kristen Protestan");
        
        jComboBox2.addItem("Kristen Katolik");
        
        jComboBox2.addItem("Budha");
        
        jComboBox2.addItem("Hindu");
        
        jComboBox2.addItem("Kong Hu Cu");
    ...
    private void initComponents() {
        ...
        setTitle("Input Data Istri/Suami");
        setResizable(false);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            ...
            JasperDesign rancanganJasper = JRXmlLoader.load("/home/steven/JavaProject/Latihan14/Latihan14/src/latihan14/HasilInputIstri.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IstriInputCetak1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IstriInputCetak1().setVisible(true);
            }
        });
    }
